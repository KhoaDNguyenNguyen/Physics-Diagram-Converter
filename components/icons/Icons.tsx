...
export const DiagramIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4H7zM10 21h4a2 2 0 002-2v-4a2 2 0 00-2-2h-4a2 2 0 00-2 2v4a2 2 0 002 2zM15 5h2a2 2 0 012 2v4a2 2 0 01-2 2h-2a2 2 0 01-2-2V7a2 2 0 012-2z" />
    </svg>
);
...
export const SparklesIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 010 1.414L10 12l-2.293 2.293a1 1 0 01-1.414 0L4 12l2.293-2.293a1 1 0 011.414 0L10 12z" />
    </svg>
);
...
export const LatexIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.5 5.5l-3 3-1.5-1.5M15.5 5.5l3 3 1.5-1.5M12 14v6M10 20h4M4 12a4 4 0 014-4h8a4 4 0 110 8H8a4 4 0 01-4-4z" />
    </svg>
);
...
export const FlipHorizontalIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 12h18M12 21V3M20 16l-4 4-4-4M4 8l4-4 4 4"/>
    </svg>
);

export const FlipVerticalIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 3v18M21 12H3M16 20l4-4-4-4M8 4l-4 4 4 4"/>
    </svg>
);
...
export const PaletteIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 21V3"/>
        <path strokeLinecap="round" strokeLinejoin="round" d="M14 5h4a2 2 0 012 2v2a2 2 0 01-2 2h-4a2 2 0 01-2-2V7a2 2 0 012-2z"/>
    </svg>
);
